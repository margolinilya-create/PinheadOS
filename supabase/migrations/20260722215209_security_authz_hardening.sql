...
-- версия 20260722215209 `security_authz_hardening`.
-- КЛЮЧЕВАЯ миграция: здесь СОЗДАЮТСЯ public.erp_is_member() и public.erp_is_manager()
-- (без неё реплей падал на 20260727200000_erp_material_suppliers_rls.sql),
-- а также функция-клампер public.erp_clamp_stage_qty() и триггер erp_item_stages_clamp_qty.
