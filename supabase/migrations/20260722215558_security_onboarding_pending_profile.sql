...
-- версия 20260722215558 `security_onboarding_pending_profile`.
-- Создаёт public.handle_new_user() и триггер on_auth_user_created на auth.users:
-- новый signup получает PENDING-профиль (approved=false, active=true) серверным триггером.
