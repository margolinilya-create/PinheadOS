-- RPC erp_create_order: персист полей подряда позиции (subcontract_kind/material_source),
-- выбранных при создании заказа (волна 4.2). Остальная логика без изменений.
