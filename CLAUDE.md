...
| `redesign/v2` | **Production-слой редизайн** | **W1+W2+W3+W4 ЗАКРЫТЫ**, MVP feature-complete, готов к UAT. Bitrix sync блокирован. | Vercel preview → v2 Supabase |
...
- 6 ADR-0001 root stores: useTechCardStore, useWorkshopStore, useForemanStore, useWorkersStore, usePayrollStore, useNotificationsStore + useUndoStore
