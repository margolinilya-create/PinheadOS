...
description: "Review recent conversations to find improvements for CLAUDE.md files. Триггеры: «улучши CLAUDE.md», «обнови контекст проекта», «что добавить в CLAUDE.md»."
---
