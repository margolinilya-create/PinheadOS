...
**Next steps (волна 2 и далее):**
1. Редактор матрицы прав в админке (правка 11) + справочники в админке (правка 12: цеха, статусы,
   причины блокировок, типы проблем, типы изделий, поставщики, нормативные сроки).
2. Закупки: несколько вариантов поставщика на позицию с выбором итогового (правка 10).
3. ТЗ в PDF (отдельный большой блок): загрузка общего/позиционного/поэтапного файла,
