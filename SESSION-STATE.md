...
## Состояние на 2026-07-27 (сессия 23, часть 6) — UI/UX-аудит ERP, волны UX-1 и UX-2
...
**Осталось по плану:** UX-4 (форма и карточка заказа), UX-5 (навигация, админка,
доступность), UX-6 (долг дизайн-системы).
Плюс с прошлой сессии: leaked password protection в дашборде Supabase.
