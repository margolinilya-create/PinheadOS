...
**Осталось по плану:** UX-3 (контраст и тач на планшете, P0 №9), UX-4 (форма и
карточка заказа), UX-5 (навигация, админка, доступность), UX-6 (долг дизайн-системы).
Плюс с прошлой сессии: leaked password protection в дашборде Supabase.

**Проверка:** lint 0, **1223 unit**, build ок, **91 e2e**.
