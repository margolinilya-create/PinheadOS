    ...
    <div className="page-container">
      <div className="page-header">
        <div className="page-header-left">
          ...
          <div className="step-label">// Админ</div>
          <h1 className="step-title">АДМИН-ПАНЕЛЬ</h1>
          <p className="step-desc">{orders.length} заказов · {totalRevenue.toLocaleString('ru-RU')} ₽</p>
        </div>
