...
export const ORDER_LIST_SELECT = `
  *,
  items:erp_order_items (
    ...
    subcontract_kind, material_source, garment_source, sku_card_id,
...
/** Сколько работ «готово/в работе» в цехе — для уведомления и числа у пункта цеха в меню */
 ...
 * цеха. Совпадает с группой «Готово к работе» в очереди, поэтому убывает при «Взять
