 ...
 *
 * Второе и нашлось разбором 11.08: `applyRealtimeEvent` умеет разбирать
...
describe('realtime: подписки и обработчики сходятся', () => {
  ...
  it('операции эксперим. цеха подписаны — та самая находка', () => {
    expect(SUB).toContain('erp_experimental_ops');
  });
});
