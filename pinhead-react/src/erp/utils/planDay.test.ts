...
describe('summarize — сводка дня и цеха', () => {
  it('пустой набор — нули, а процент неизвестен (не 100)', () => {
    // «100%» на пустой неделе читалось как «всё сделано» там, где не
    // запланировано ничего: ровно то, из-за чего /plan показывал сплошные 100.
