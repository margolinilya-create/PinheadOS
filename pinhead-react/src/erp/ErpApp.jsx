      ...
      >
        <Suspense fallback={<ScreenSkeleton />}>
          ...
          {/*
            ...
            больше нет (правки 07.09, п. 18): он открывал «Мой цех» — экран,
            который сам догадывался, чей участок показать, и при неудаче
            показывал заглушку «Ваш профиль не привязан к цеху». Цеховая роль
            попадает в свою очередь посадочной (`utils/landing`), остальные —
            через группу «Цеха» в меню. Устаревшая ссылка на `/queue` уходит
            на обзор общим `path="*"` ниже.
          */}
