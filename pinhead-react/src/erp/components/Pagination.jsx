...
/**
 * Размер страницы по умолчанию — ОДИН на все таблицы ERP.
 *
 * M-17 отчёта QA 13.08.2026: «Заказы» открывались по 25 строк, а «Склад»,
 * «Закупка» и «Эксперим. цех» — по 10. Одинаковые на вид таблицы вели себя
 * по-разному, и человек, привыкший к одной, на другой считал, что данных
 * меньше. Значение живёт рядом с компонентом, который его показывает.
 */
