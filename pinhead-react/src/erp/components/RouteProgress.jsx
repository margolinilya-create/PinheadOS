    ...
    <div className={styles.routeProgress}>
      <div className={styles.routeTotal}>
        ...
        {/*
          ...
          Но и «шт·этапов» — внутренний жаргон (M-19 отчёта QA 13.08.2026):
          такой единицы измерения нет ни в цехе, ни в разговоре. Пишем словами
          то, что число означает, — «пройдено по этапам».
        */}
        <span
          className={styles.subText}
          title={`Сумма по всем этапам маршрута: ${total.done} из ${total.total}. Одно изделие считается столько раз, сколько цехов в его маршруте`}
        >
          {total.done}/{total.total} пройдено по этапам
        </span>
      </div>
