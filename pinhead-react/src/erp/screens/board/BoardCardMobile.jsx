 ...
 *
 * ДО 03.09 ЭТО БЫЛО ТОЛЬКО ОБЕЩАНИЕМ: `ProductionBoard` передавал сюда тот же
 * кликабельный чип, что и в таблицу, и тап действительно переводил этап
 * `ready → in_progress`, назначая исполнителя и не спрашивая ничего.
 * Теперь чип приезжает без права на действие (`renderStage(..., false)`).
 */
