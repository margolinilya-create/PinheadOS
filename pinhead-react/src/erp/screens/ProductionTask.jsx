...
export default function ProductionTask() {
  ...
  const reason = (display === 'waiting' || display === 'blocked')
    ? waitingReason(stage, item.stages, order.materials, deptNameById, dept?.code, awaitProc)
    : null;
  ...
  return (
    <>
      ...
      <div className={styles.toolbar}>
        ...
        {overdue && <Badge variant="blocked">⏰ Этап просрочен</Badge>}
      </div>
      ...
      <div className={styles.taskGrid}>
        <section className={styles.matSection}>
          ...
          {stage.status === 'blocked' && stage.block_reason && (
            <div className={`${styles.queueReason} ${styles.overdue}`}>🚫 {stage.block_reason}</div>
          )}
        </section>
