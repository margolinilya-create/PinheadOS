    ...
    <>
      ...
      {notNeededByItems && (
        <p className={styles.subText} role="status">
          По составу заказа покупать нечего: изделия давальческие либо берутся
          со склада готовой продукции. Лист закупки не обязателен — приложить
          его всё равно можно, закупают не только само изделие.
        </p>
      )}
