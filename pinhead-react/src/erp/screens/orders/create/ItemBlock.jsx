  ...
  return (
    ...
    <div className={styles.itemRow}>
      <label className={styles.field}>
        ...
        {/* Подсказки из каталога SKU, дополненные справочником типов изделий:
            каталог — источник правды по ассортименту, справочник закрывает то,
            чего в нём ещё нет. Ввод остаётся свободным. */}
        <input
      ...
      {/* Крой стоит между цветом и количеством: документ задаёт порядок
          ...
          Ввод свободный с подсказками КАТАЛОГА: крой у SKU уже проставлен,
          поэтому список сам сжимается до того, что фабрика реально шьёт.
          Перечислением в коде это быть не может — у каждого заказчика свои
          лекала, и любое новое название означало бы миграцию. */}
      <label className={styles.field}>
