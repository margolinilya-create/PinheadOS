 ...
 *
 * ПОРЯДОК МЕНЯЕТСЯ КНОПКАМИ ↑/↓, а не перетаскиванием: у любого перетаскивания
 * обязана быть клавиатурная альтернатива (правило проекта), а здесь строк
 * немного и кнопки её полностью заменяют — заодно они работают на планшете.
 *
