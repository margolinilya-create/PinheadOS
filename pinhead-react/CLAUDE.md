...
- Потолок оболочки — 222 кБ gzip (был 250, упирались в 249). Бюджет, к которому
  ...
  такое видит
- Остаток оболочки (~38 кБ) — ЕДИНЫЙ стор со всеми 16 слайсами: его использует
  layout, поэтому слайсы подряда, склада и образцов едут всем. Разделение стора
  на «ядро» и ленивые слайсы — отдельная работа, не сделана
