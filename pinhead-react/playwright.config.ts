  ...
  projects: [
    ...
    },
    {
      ...
      testIgnore: [
        ...
        /erp-a11y\.spec\.ts/,
        /*
          app-mode проверяет ПЕРЕКЛЮЧЕНИЕ РАЗДЕЛОВ, а его кнопки живут
          в десктопной шапке: на 375px шапка Order Studio сворачивается
          в бургер, и «🏭 Производство» физически нет на экране. Сам механизм
          от ширины не зависит — блокер держался на `beforeunload`, — и правила
          выбора режима покрыты юнитом `src/config/appMode.test.ts`.
        */
        /app-mode\.spec\.ts/,
      ],
    },
