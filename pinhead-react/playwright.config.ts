  ...
  projects: [
    ...
    },
    {
      ...
      testIgnore: [
        ...
        /erp-a11y\.spec\.ts/,
        // erp-admin меряет ГЕОМЕТРИЮ матрицы прав на 1280px: липкую шапку
        // и то, сколько ролей помещается по ширине. На 375px пятнадцать
        // колонок не помещаются по построению, и порог был бы бессмыслицей
        /erp-admin\.spec\.ts/,
