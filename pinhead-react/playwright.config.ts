  ...
  projects: [
    ...
    },
    {
      ...
      testIgnore: [
        ...
        // erp-gantt проверяет ДЕСКТОПНУЮ шкалу: сетку дней, полосу в её
        // колонках и признак «догадки» на самой полосе. Ниже 1024px шкалы нет
        // вовсе — сжатая на 375px, она была бы полосой шириной в пиксель,
        // и экран показывает текстовые интервалы карточкой на заказ.
        // Эта раскладка покрыта в erp-tablet.spec.ts — на той ширине,
        // на которой ею и пользуются
        /erp-gantt\.spec\.ts/,
