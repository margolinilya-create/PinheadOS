...
| 13 | Стражи по списку колонок | **исправлено** в сессии 68 для четырёх (вложения, уведомления, план, этапы; `20260924231233`); `erp_material_guard` — не тот класс, решение владельца |
| 9, 11, 12, 14, 15 | остальное | не начато, порядок ниже |
