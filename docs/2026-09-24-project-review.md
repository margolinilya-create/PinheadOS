...
| № | Находка | Статус |
|---|---|---|
| 1 | Бэкапа Storage нет | **за владельцем** — два секрета в GitHub. Сессия 68: ручной запуск из сессии невозможен — у GitHub-интеграции нет `actions: write` (403); ждём ночной прогон |
